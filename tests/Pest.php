 ...
 * when that file happened to be loaded: a full run declared it, and a run of
 * any single other file that calls it died with "Call to undefined function
 * grant()" -- in a workflow CLAUDE.md documents as ordinary. Three test files
 * call it now, so it belongs here.
 */
